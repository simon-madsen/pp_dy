...
amp_object_raw <- readRDS(here("data", "d_initial_Simon_subset.rds")) %>%
  amp_filter_samples(SampleSite == "Randers")
...
# 
# amp_object_raw$metadata$SampleSite <- "Randers"
# 
...
# 
# amp_object_raw <- amp_subset_taxa(amp_object_raw,tax_vector = filter)
...
```{r lsp_and_peak_finding, echo=TRUE, message=FALSE, warning=FALSE}
...
for (site in sample_sites) {
  ...
  site_asv_matrix <- t(site_amp_object_rclr$abund["ASV2",])
